...
#
#
# def point_within_gca(point: Point | PointArray, gca: GreatCircleArc | GreatCircleArcArray):
#
...
#
# @njit(cache=True)
# def _vectorized_point_within_gca(pt, gca_arr_a, gca_arr_b):
#
#     n_gca = gca_arr_a.shape[1]
#
#     results = np.zeros((n_gca, ), dtype=np.bool)
#
#     for i in range(n_gca):
#         results[i] = point_within_gca(pt, gca_arr_a[:, i], gca_arr_b[:, i])
#
#
#     return results
#
